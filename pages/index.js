		...
		<div>
			...
			<Container className='mt-5'>
				...
				<section className='hero'>
					...
					<hr />
					<p>
						Для обмінну даними між Веб клієнтом та Веб сервісом через систему
						Трембіта використовується HTTPS протокол. При першому старті
						клієнту(в разі єго відсутності) одноразово генерується самопідписний
						сертифікат. Щоб зареєструвати новостворений клієнт в системі
						Трембіта завантажте та передайте сертифікат системному
						адміністратору.
					</p>
